...
export const getPermit = (account: string | undefined, hash: string | undefined): PermitV2 | undefined => {
...
export const getActivePermit = (account: string | undefined): PermitV2 | undefined => {
...
export const getPermits = (account: string | undefined): Record<string, PermitV2> => {
  if (account == null) return {};

  return Object.entries(permitsStore.getState().permits[account] ?? {}).reduce((acc, [hash, permit]) => {
...
export const getActivePermitHash = (account: string | undefined): string | undefined => {
